<x-app-layout title="{{ $gasoline->type }}">
    <div class="container mx-auto px-4 py-8 h-screen">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">السيارات التي تعمل بـ {{ $gasoline->type }}</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse ($gasoline->cars as $car)
            ...
            @empty
                <p class="text-gray-600">لا توجد سيارات تعمل بهذا النوع من الوقود.</p>
            @endforelse
        </div>
    </div>
</x-app-layout>
