    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 h-[80vh]">
            ...
            @if(isset($chat) && $chat->messages->isNotEmpty())
                    <div class="col-span-2 flex flex-col justify-between bg-gray-50 p-4 rounded-lg shadow-lg overflow-hidden">
                        <!-- Chat Messages -->
                        ...
                        @auth
                            <form action="{{ route('chats.send', $chat) }}" method="POST" class="flex space-x-4">
                                @csrf
                                <textarea name="content" rows="2" placeholder="اكتب رسالتك هنا..." class="flex-grow px-1 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500" required></textarea>
