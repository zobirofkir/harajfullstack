<x-app-layout>
    <div class="container mx-auto py-8 h-screen md:px-0 px-10">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">نتائج البحث</h2>

        @if ($cars->isEmpty())
            <p class="text-gray-600">لا توجد سيارات بهذا العنوان.</p>
        @else
